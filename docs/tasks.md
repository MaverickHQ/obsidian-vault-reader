...
- Renamed the private working repository to `MaverickHQ/obsidian-vault-reader-build-lab`.
- Updated the main working copy `origin` to `https://github.com/MaverickHQ/obsidian-vault-reader-build-lab.git`.
